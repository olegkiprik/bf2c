...
bf2c: main.c bf2c_basics.h
	$(CC) $(COMMON_FLAGS) -DNDEBUG -s -fstrict-aliasing -O3 -ffast-math -Wstrict-aliasing -Wno-unused-variable -Wno-unused-function -Wno-unused-parameter -Wno-unused-label -Wno-parentheses -o $@ main.c
